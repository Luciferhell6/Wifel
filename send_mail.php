...
try {
    ...
    //Recipients
    $mail->setFrom('nafa.fares@gmail.com', 'Mailer');         //Set the sender of the message (your email address)
    $mail->addAddress('nafa.fares123@gmail.com', 'Joe User');     //Add a recipient (your bae's email address)
